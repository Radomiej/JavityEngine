...
/**
 * Represents a line by means of three coefficients a, b and c, where ax + by +
 * c = 0 holds.
 * 
...
public class Line {
	...
	/**
	 * Initializes a line by the three coefficients a, b and c, where ax + by +
	 * c = 0 holds.
	 * 
	 * @param a
	 *            The a coefficient
	...
	/**
	 * Returns the a coefficient for the line, where ax + by + c = 0 holds.
	 * 
	...
	/**
	 * Returns the b coefficient for the line, where ax + by + c = 0 holds.
	 * 
	...
	/**
	 * Returns the c coefficient for the line, where ax + by + c = 0 holds.
	 * 
	...
	/**
	 * Determines whether the line is ascending (that is, makes an angle with
	 * the positive direction of the X axis that lies in (0, pi/2).
	 * 
	...
	/**
	 * Determines whether the line is vertical (that is, makes an angle with the
	 * positive direction of the X axis that is equal to pi/2.
	 * 
	...
	/**
	 * Determines whether the line is descending (that is, makes an angle with
	 * the positive direction of the X axis that lies in (pi/2, pi).
	 * 
	...
	/**
	 * Determines whether the line is horizontal (that is, makes an angle with
	 * the positive direction of the X axis that is equal to pi.
	 * 
	...
	/**
	 * Determines whether the line is undefined (e.g. two equal points were
	...
	/**
	 * Calculates the angle that the line makes with the positive direction of
	 * the X axis.
	 * 
	...
	/**
	 * Calculates the perpendicular line that passes through the given point.
	 * 
	 * @param p
	 *            Point that the perpendicular passes through
	...
	/**
	 * Determines whether the point lies on the left side of the line.
	 * 
	 * @param p
	 *            The point
	...
	/**
	 * Determines whether the point lies on the right side of the line.
	 * 
	 * @param p
	 *            The point
