...
public class DependencyBank {
	...
	static String javityEngineVersion = "0.6.0-SNAPSHOT";	
	...
	public enum ProjectDependency {
		GDX(
			new String[]{"com.badlogicgames.gdx:gdx:$gdxVersion", "com.badlogicgames.gdx:gdx-box2d:$gdxVersion","com.badlogicgames.gdx:gdx-freetype:$gdxVersion"},
			...
			new String[]{"com.badlogicgames.gdx:gdx-backend-android:$gdxVersion", "com.badlogicgames.gdx:gdx-platform:$gdxVersion:natives-armeabi", "com.badlogicgames.gdx:gdx-platform:$gdxVersion:natives-armeabi-v7a", "com.badlogicgames.gdx:gdx-platform:$gdxVersion:natives-arm64-v8a", "com.badlogicgames.gdx:gdx-platform:$gdxVersion:natives-x86", "com.badlogicgames.gdx:gdx-platform:$gdxVersion:natives-x86_64", "com.badlogicgames.gdx:gdx-box2d:$gdxVersion", "com.badlogicgames.gdx:gdx-box2d-platform:$gdxVersion:natives-armeabi", "com.badlogicgames.gdx:gdx-box2d-platform:$gdxVersion:natives-armeabi-v7a", "com.badlogicgames.gdx:gdx-box2d-platform:$gdxVersion:natives-arm64-v8a", "com.badlogicgames.gdx:gdx-box2d-platform:$gdxVersion:natives-x86", "com.badlogicgames.gdx:gdx-box2d-platform:$gdxVersion:natives-x86_64", "com.badlogicgames.gdx:gdx-freetype:$gdxVersion", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-armeabi", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-armeabi-v7a", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-arm64-v8a", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-x86", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-x86_64"},
			new String[]{"com.mobidevelop.robovm:robovm-rt:$roboVMVersion", "com.mobidevelop.robovm:robovm-cocoatouch:$roboVMVersion", "com.badlogicgames.gdx:gdx-backend-robovm:$gdxVersion", "com.badlogicgames.gdx:gdx-platform:$gdxVersion:natives-ios", "com.badlogicgames.gdx:gdx-box2d-platform:$gdxVersion:natives-ios", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-ios"},
			new String[]{"com.badlogicgames.gdx:gdx-backend-moe:$gdxVersion", "com.badlogicgames.gdx:gdx-platform:$gdxVersion:natives-ios", "com.badlogicgames.gdx:gdx-box2d-platform:$gdxVersion:natives-ios", "com.badlogicgames.gdx:gdx-freetype-platform:$gdxVersion:natives-ios"},
			new String[]{"com.badlogicgames.gdx:gdx-backend-gwt:$gdxVersion", "com.badlogicgames.gdx:gdx:$gdxVersion:sources", "com.badlogicgames.gdx:gdx-backend-gwt:$gdxVersion:sources", "com.badlogicgames.gdx:gdx-box2d:$gdxVersion:sources", "com.badlogicgames.gdx:gdx-box2d-gwt:$gdxVersion:sources"},
			new String[]{"com.badlogic.gdx.backends.gdx_backends_gwt"},
			
			"Core Library for LibGDX"
		),
		JAVITY(
				new String[]{"pl.javity:javity-engine:$javityEngineVersion"},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{"pl.javity"},
				
				"Javity Engine"
		),
		NET(
				new String[]{"pl.javity.plugins:net:$javityEngineVersion"},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{"pl.javity.plugins.net"},
				
				"Javity Net plugin for support HTTP and REST web services"
		),
		ANDROID(
				new String[]{"pl.javity.plugins:android:$javityEngineVersion"},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{"pl.javity.plugins.android"},
				
				"Javity Android plugin for support native Android features"
		),
		Ui(
				new String[]{"pl.javity.plugins:xml-scene2d-ui:$javityEngineVersion"},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{},
				new String[]{"pl.javity.plugins.xml-scene2d-ui"},
				
				"Javity XML Scene2d.UI"
		),
		BOX2DLIGHTS(
